export default function Home() {
  return (
    <main id="homeView" class="view is-active">
      <section className="relative pt-18 pb-22.5 overflow-hidden">
        ...
        <div
          ...
          aria-hidden="true"
        ></div>
        <div class="max-w-295 mx-auto px-6  relative text-center ">
          ...
          <h1 className="font-display tracking-[0.01em] text-[clamp(42px,8vw,74px)] leading-[0.98] mb-5">
            Discover your <br /> next obsession
          </h1>
          <p className="text-[17px] leading-[1.6] text-text-muted max-w-120 mx-auto mb-8.5">
            Browse titles pulled from a real show catalog, search by name, and
            get the full picture — ratings, genres, and story — before you press
            play.
          </p>
          <button
            className="inline-flex items-center gap-2.5 bg-gold text-[#1B1300] border-none font-extrabold text-[15px] px-7.5 py-3.75 rounded-full shadow-[0_10px_30px_-8px_color-mix(in_srgb,var(--gold)_55%,transparent)] transition-all duration-150 ease-out hover:-translate-y-0.5 hover:brightness-[1.06]"
            id="heroCta"
          >
            Explore now
            <svg
